 ...
 class configuracion (tkinter.Tk):
    def __init__(menu):
        ...
        menu.otro.place  (x=20,y=347)
         """Regresar"""
        menu.regreso = crearBoton(menu, "botoninicio", "Regresar al menú", 260, 370, 17, menu.regresar)
        menu.regreso.configure(bg = "lightblue")
         menu.jugar = crearBoton(menu, "jugar", "Jugar", 150, 370, 10, lambda: menu.juego());
        menu.jugar.configure         (bg = "mediumpurple")
    ...
    def __init__(menu):
        ...
        menu.config(menu = menubar)
         ...
         if crono==1 or crono==2:
            ...
            pass
         #______________________BOTONES__________________________#
         menu.botoniniciar        = crearBoton(menu, "botoniniciar",  "Iniciar Juego",          35, 500, 12, menu.iniciar)
        menu.botoniniciar.configure       (bg = "red")
         menu.botonvalidacion = crearBoton(menu, "botonvalidacion", "Validar Juego",   165, 500, 12, menu.nada)
        menu.botonvalidacion.configure(bg = "yellow3")
        menu.botonvalidacion.configure(fg = "yellow3")        
         menu.botonotrojuego  = crearBoton(menu, "botonotrojuego",  "Otro Juego",      295, 500, 12, menu.nada)
        menu.botonotrojuego.configure (bg = "turquoise4")
        menu.botonotrojuego.configure (fg = "turquoise4")
         menu.botonreinicio   = crearBoton(menu, "botonreinicio",   "Reiniciar Juego", 425, 500, 15, menu.nada)
        menu.botonreinicio.configure  (bg = "gray64")
        menu.botonreinicio.configure  (fg = "gray64")
         menu.botontermina    = crearBoton(menu, "botontermina",    "Terminar Juego",  583, 500, 15, menu.nada)
        menu.botontermina.configure   (bg = "gray1")
        menu.botontermina.configure   (fg = "gray1")
         menu.botontop        = crearBoton(menu, "botontop",        "Top 10",          740, 500, 12, menu.top)
        menu.botontop.configure       (bg = "aquamarine4")
         menu.regreso         = crearBoton(menu, "botoninicio", "Regresar al menú", 695, 550, 17, menu.regresar)
        menu.regreso.configure        (bg = "lightblue")
