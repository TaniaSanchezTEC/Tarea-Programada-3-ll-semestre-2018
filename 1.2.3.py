...
class juego(tkinter.Tk):
    def __init__(menu):
        ...
        menu.guardar         = crearBoton(menu, "botonguardar", "Guardar juego", 773, 550, 13, menu.guardar)
        ...
        menu.nombre = crearEtiqueta(menu, "nombre", "Nombre del jugador", 10, 600)
        menu.nombre.configure (fg = "black")

        menu.txtnombre = crearEtiqueta(menu, "recibe nombre",str(nombreusuario), 185, 600)
    ...
    def digitaNumero(menu, numero):
        ...
        if (campoTexto == "texto11" or campoTexto == "texto12" or campoTexto == "texto13"or campoTexto == "texto14"or campoTexto == "texto15"or \
            campoTexto == "texto16"or campoTexto == "texto21"or campoTexto == "texto22"or campoTexto == "texto23"or campoTexto == "texto24"or \
            campoTexto == "texto25"or campoTexto == "texto26"or campoTexto == "texto31"or campoTexto == "texto32"or campoTexto == "texto33"or \
            campoTexto == "texto34"or campoTexto == "texto35"or campoTexto == "texto36"or campoTexto == "texto41"or campoTexto == "texto42"or \
            campoTexto == "texto43"or campoTexto == "texto42"or campoTexto == "texto43"or campoTexto == "texto44"or campoTexto == "texto45"or \
            campoTexto == "texto46"or campoTexto == "texto51"or campoTexto == "texto52"or campoTexto == "texto53"or campoTexto == "texto54"or \
            campoTexto == "texto55"or campoTexto == "texto56"or campoTexto == "texto60"or campoTexto == "texto61"or campoTexto == "texto62"or \
            campoTexto == "texto63"or campoTexto == "texto64"or campoTexto == "texto65"or campoTexto == "texto66"):
            foco.delete('1.0', END)
